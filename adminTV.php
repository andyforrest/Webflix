...
$sql = "SELECT * FROM media WHERE type = 'TV Show'";
...
echo '<div class="container">';
  while ( $row = mysqli_fetch_array( $r, MYSQLI_ASSOC ))
  {
   echo '<div class="alert alert-dark" role="alert">
    ...
    <p>URL: ' . $row['preview'] . '</p>
    <p>Number of Seasons: ' . $row['num_seasons'] . '</p>
    <p>Number of Episodes: ' . $row['num_episodes'] . '</p>

	</footer>
    <a href="editTV.php?id='.$row['media_id'].'" class="btn btn-secondary btn-block" role="button">
    Edit</a>
	</div>
';  
