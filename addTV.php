...
# Check to see if form filled in.
  ...
  { $errors[] = 'release_year cannot be blank' ; }
  else
  ...
  { $errors[] = 'number of seasons cannot be blank' ; }
  else
  { $num_seasons = mysqli_real_escape_string( $link, trim( $_POST[ 'num_seasons' ] ) ) ; }


  if ( empty( $_POST[ 'num_episodes' ] ) )
  { $errors[] = 'Number of episodes cannot be blank' ; }
  else
  { $num_episodes = mysqli_real_escape_string( $link, trim( $_POST[ 'num_episodes' ] ) ) ; }
 ...
 if(empty($errors)){
     ...
     $sql = "INSERT INTO media(`media_title`, `category`, `type`, `further_info`, `release_year`, `language`, `duration`, `img`, `preview`,
     `num_seasons`, `num_episodes`) VALUES ('$mt', '$cat', '$ty', '$fi', '$release_year',
     '$language', '$duration', '$img', '$pv', '$num_seasons', '$num_episodes' )";
   ...
   <div class="col-sm">
       <div class="card bg-light mb-3">
         <div class="card-header">Add Media  </div>
           <div class="card-body">
           <form action="addTV.php" class="was-validated" method="post">
                ...
                <select class="form-select" id="inputGroupSelect01" name="language" aria-label=".form-select-lg example">
    ...
    <option value="zu">Zulu - isiZulu</option>
        ...
        <small id="emailHelp" class="form-text text-muted">Number of Seasons</small>
                   <input type="number" name="num_seasons" class="form-control"    required>
                </div>

                <div class="form-group">
        <small id="emailHelp" class="form-text text-muted">Number of Episodes</small>
                   <input type="number" name="num_episodes" class="form-control"  required>
                </div>
