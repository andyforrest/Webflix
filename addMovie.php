...
# Check to see if form filled in.
 ...
 if(empty($errors)){
     ...
     $sql = "INSERT INTO media(`media_title`, `category`, `further_info`, `release_year`, `language`, `duration`, `img`, `type`, `preview`) VALUES ('$mt', '$cat',  '$fi', '$release_year',
     '$language', '$duration', '$img', '$ty', '$pv' )";
   ...
   <div class="col-sm">
       <div class="card bg-light mb-3">
         <div class="card-header">Add Media  </div>
           <div class="card-body">
           <form action="addMovie.php" class="was-validated" method="post">
