       ...
       <div class="card bg-light mb-3">
         <div class="card-header">Edit Media ' . $_GET['id'] . ' </div>
           ...
           <form action="updateTV.php" class="was-validated" method="post">
                ...
                <input type="number" name="release_year" class="form-control" value=' . $row['release_year'] . '  required>
                ...
                <select class="form-select" id="inputGroupSelect01" name="language" aria-label=".form-select-lg example" value=' . $row['language'] . ' >
...
<div class="form-group">
        <small id="emailHelp" class="form-text text-muted">Number of Seasons</small>
                   <input type="number" name="num_seasons" class="form-control" placeholder="url" value=' . $row['num_seasons'] . '  required>
                </div>

                <div class="form-group">
        <small id="emailHelp" class="form-text text-muted">Number of Episodes</small>
                   <input type="number" name="num_episodes" class="form-control" placeholder="url" value=' . $row['num_episodes'] . '  required>
                </div>
                
        <input type="submit" class="btn btn-secondary btn-lg btn-block" value="Submit"></p>
        <a href="deleteTV.php?id='.$row['media_id'].'" class="btn btn-secondary btn-block" role="button" style="background-color:red;">
    Delete Media</a>
         </div>
       </div>
   </div>
